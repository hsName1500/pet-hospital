...
<el-row :gutter="0" >
  ...
  <div class="bb-1" >
    <div class="cm">
      ...
      <!-- 2 -->
     <div class="ab-1" v-if="data1">
      <div class="ab-1-1" v-for="x in data1" :key="x.id">
        <img :src="`/Tips/${x.img}`" alt="" @click="getid(x.id)">
        <a href="#" class="a1">{{x.title}}</a>
        <a href="#">{{x.content}}</a>
      </div>
  ...
  <div class="bb-1">
    <div class="cm">
      ...
      <!-- 2 -->
     <div class="ab-1" v-if="data2">
      <div class="ab-1-1" v-for="x in data2" :key="x.id">
        <img :src="`/Tips/${x.img}`" alt="" @click="getid(x.id)">
        <a href="#" class="a1">{{x.title}}</a>
        <a href="#">{{x.content}}</a>
      </div> 
...
export default {
    mounted () {
        ...
        this.loadData('/order/cat',(res)=>{
          this.data2=res.data
        })
        this.loadData('/order/dog',(res)=>{
          this.data1=res.data
        })
    },
    methods: {
